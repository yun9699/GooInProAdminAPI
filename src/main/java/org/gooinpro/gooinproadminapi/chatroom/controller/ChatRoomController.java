...
public class ChatRoomController {
    ...
    public ResponseEntity<ChatRoomGetDTO> getChatRoom(@PathVariable Long eno) {
        ...
        ChatRoomGetDTO dto = chatRoomService.findChatRoom(eno);
...
//    }
    ...
    public ResponseEntity<ChatRoomGetDTO> getChatPartRoom(@PathVariable Long pno) {
        ...
        ChatRoomGetDTO dto = chatRoomService.findChatPartRoom(pno);
...
//    }
//
//    @DeleteMapping("/delete/emp/{eno}") // 고용인 채팅방 삭제
...
//    }
    ...
    @DeleteMapping("/delete/all/{rno}")
    public ResponseEntity<String> deleteChat(@PathVariable Long rno) {
        log.info("Deleting chat room with pno");

        return ResponseEntity.ok().body(chatRoomService.deleteChat(rno));
    }
}
